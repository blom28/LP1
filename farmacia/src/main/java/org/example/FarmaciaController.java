...
public class FarmaciaController {
    ...
    @FXML
    private void Botao_Antibiotico() {texto.setText(remedios.antibiotico());

    }

    @FXML
    private void Botao_Inflamatorio() {texto.setText(remedios.inflamatorio());

    }

    @FXML
    private void Botao_Xarope() {texto.setText(remedios.xarope());
